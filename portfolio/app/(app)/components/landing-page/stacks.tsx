export default function Stacks() {
  const stacks = [
    ...
    {
      name: "React",
      icon: <img src="/react.png" alt="React" className="w-20 h-20" />,
    },
    {
      name: "Next.js",
      icon: <img src="/nextjs-logo.png" alt="Next.js" className="w-20 h-20" />,
    },
    {
      name: "TypeScript",
      icon: (
    ...
    <div className="flex flex-col justify-center items-center min-h-screen p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl">
        {stacks.map((stack) => (
          <div
            key={stack.name}
            className="flex flex-col items-center justify-center p-6 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl shadow-lg hover:shadow-2xl hover:scale-110 transition-all duration-300"
          >
            <div className="text-[#A1223C] mb-4">{stack.icon}</div>
